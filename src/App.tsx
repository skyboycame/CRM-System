    ...
    <div className="container">
      {
        !isLoading ? (
          <>
          <CreateTodo valitateTitle={valitateTitle} inputValue={inputValue} setInputValue={setInputValue} createNewTodo={createNewTodo} todos={data}></CreateTodo>
          <TodoList valitateTitle={valitateTitle} changeHadler={changeHadler} deleteTodo={deleteTodo} todos={data}></TodoList>
          </>
        ) : (
          <h3>Loading...</h3>
        )
